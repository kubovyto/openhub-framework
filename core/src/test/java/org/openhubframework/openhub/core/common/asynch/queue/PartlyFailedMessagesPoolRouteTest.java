...
public class PartlyFailedMessagesPoolRouteTest extends AbstractCoreTest {
    ...
    public void testRunningMode() throws Exception {
        assertThat(nodeService.getActualNode().isProcessNewMessages(), is(true));
        assertThat(nodeService.getActualNode().isProcessExistingMessages(), is(true));
    ...
    public void testProcessExistingMessage() throws Exception {
        Node node = nodeService.getActualNode();
        node.processOnlyExistingMessage();
        nodeService.updateNode(node);

        assertThat(nodeService.getActualNode().isProcessNewMessages(), is(false));
        assertThat(nodeService.getActualNode().isProcessExistingMessages(), is(true));
        assertThat(nodeService.getActualNode().isStopped(), is(false));
    ...
    public void testStopped() throws Exception {
        ...
        assertThat(nodeService.getActualNode().isProcessNewMessages(), is(false));
        assertThat(nodeService.getActualNode().isProcessExistingMessages(), is(false));
