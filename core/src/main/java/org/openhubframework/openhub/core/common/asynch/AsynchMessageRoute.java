...
public class AsynchMessageRoute extends AbstractBasicRoute {
    ...
    protected void doConfigure() throws Exception {
        ...
        from(URI_SYNC_MSG)
                ...
                .bean(ROUTE_BEAN, "isProcessExistingMessage")
     ...
     *
     * @throws StoppingException if node not proess existing message
     */
    @Handler
    public void isProcessExistingMessage() throws StoppingException {
        NodeService nodeService = getApplicationContext().getBean(NodeService.class);

        if (!nodeService.getActualNode().isProcessExistingMessages()) {
